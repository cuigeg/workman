        ...
        <form class="layui-form " action="">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <img style="width: 150px;height: 40px;margin-left: 10px;cursor: pointer" id="refresh_img" src="/image_code?key={{ $code_hash }}" alt="">
                    <input type="hidden" name="key" id="code_hash" value="{{ $code_hash }}">
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
...
<script>
    layui.use(['upload','jquery'], function(){
        ...
        //刷新验证码
        $(document).on('click', '#refresh_img', function(data) {
            var that = this;
            $.ajax({
                url:"/refresh_img",
                type:"post",
                ...
                success:function(res){
                    if (res.code === 200) {
                        $('#refresh_img').attr('src','/image_code?key='+res.data.code_hash)
                        $('#code_hash').val(res.data.code_hash)
                    }
                },
                error:function(){
